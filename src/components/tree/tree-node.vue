<template>
  ...
  >
    <div class="b-tree-node__content"
      ...
      <span
        class="b-tree-node__expand-icon"
      ...
      <span
        v-if="node.loading"
        class="b-tree-node__loading-icon b-icon-loading">
      </span>
...
<script>
import BCollapseTransition from './utils/collapse-transition'
import { BCheckbox } from '@/components/checkbox'
import Emitter from '@/utils/mixins/emitter'

export default {
  name: 'BTreeNode',
  componentName: 'BTreeNode',
  mixins: [Emitter],
  props: {
    node: {
      default() {
      ...
      render(h) {
        ...
        return (
          parent.renderContent
            ...
            : <span class="b-tree-node__label">{this.node.label}</span>
        )
      }
    }
  },
