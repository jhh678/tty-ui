<template>
  <div class="b-tree" :class="{ 'b-tree--highlight-current': highlightCurrent }" role="tree">
    <b-tree-node v-for="child in root.childNodes" :node="child" :props="props" :key="getNodeKey(child)" :render-content="renderContent"
...
<style lang="scss">
  ...
  .b-tree--highlight-current .b-tree-node.is-current>.b-tree-node__content:hover {
