  ...
  <div class="carousel slide" data-ride="carousel" @mouseenter="stopInterval" @mouseleave="startInterval">
    <slot v-if="indicators" name="indicators">
      <ol class="carousel-indicators">
        <li v-for="(slide,index) in slides" :class="{active:index===activeIndex}" :key="index" @click="select(index)"></li>
      </ol>
    </slot>
...
export default {
  props: {
    ...
    iconControlLeft: {
      type: String,
      'default': 'iconfont icon-shangyiye'
    },
    iconControlRight: {
      type: String,
      'default': 'iconfont icon-xiayiye'
    }
  },
  data() {
    return {
