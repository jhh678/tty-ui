<template>
  <transition name="b-zoom-in-top" @after-leave="$emit('dodestroy')">
    <div v-show="visible" :style="{
        width: width + 'px'
      }" class="b-picker-panel b-date-picker" :class="[{
      ...
      <div class="b-picker-panel__body-wrapper">
        ...
        <div class="b-picker-panel__body">
          <div class="b-date-picker__time-header" v-if="showTime">
            <span class="b-date-picker__editor-wrap">
              <b-input
                placeholder="选择日期"
                :value="visibleDate"
                size="small"
                @change.native="visibleDate = $event.target.value"></b-input>
            </span>
            <span class="b-date-picker__editor-wrap">
              <b-input
                ref="input"
                ...
                :value="visibleTime"
                size="small"
                @change.native="visibleTime = $event.target.value"></b-input>
              <time-picker
                ref="timepicker"
                :date="date"
          ...
          <div class="b-date-picker__header" v-show="currentView !== 'time'">
            <button type="button" @click="prevYear" class="b-picker-panel__icon-btn b-date-picker__prev-btn iconfont icon-first">
            </button>
            <button type="button" @click="prevMonth" v-show="currentView === 'date'" class="b-picker-panel__icon-btn b-date-picker__prev-btn iconfont icon-front">
            </button>
            <span @click="showYearPicker" class="b-date-picker__header-label">{{ yearLabel }}</span>
            <span @click="showMonthPicker" v-show="currentView === 'date'" class="b-date-picker__header-label" :class="{ active: currentView === 'month' }">{{month + 1}} 月</span>
            <button type="button" @click="nextYear" class="b-picker-panel__icon-btn b-date-picker__next-btn iconfont icon-last">
            </button>
            <button type="button" @click="nextMonth" v-show="currentView === 'date'" class="b-picker-panel__icon-btn b-date-picker__next-btn iconfont icon-next">
            </button>
          </div>

          <div class="b-picker-panel__content">
      ...
      <div class="b-picker-panel__footer" v-show="footerVisible && currentView === 'date'">
        <a class="b-picker-panel__link-btn" @click="changeToNow">此刻</a>
        <button type="button" class="b-picker-panel__btn" @click="confirm">确定</button>
      </div>
    </div>
  </transition>
</template>
