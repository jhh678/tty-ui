/* * @File: 树形控件 * @Author: jhh678 * @Date: 2018-03-28 16:47:05 * @Last Modified by: jhh678 * @Last Modified time: 2018-04-03
11:48:38 */
...
<template>
  <div class="sub-page-wrap">
    ...
    <section class="panel panel-default">
      ...
      <div class="panel-body">
        <b-tree :data="selectTreeData" show-checkbox node-key="id" default-expand-all highlight-current :props="defaultProps" ref="tree"></b-tree>
        <div class="buttons">
          <button class="btn btn-default" @click="getTreeNodes">获取所有树节点</button>
    ...
    <section class="panel panel-default">
      <div class="panel-heading">
        ...
        <div class="text-muted">使用
          <code>render-content</code>指定渲染函数，该函数返回需要的节点区内容即可。渲染函数的用法请参考 Vue 文档。注意：由于 jsfiddle 不支持 JSX 语法，所以本例在 jsfiddle 中无法运行。但是在实际的项目中，只要正确地配置了相关依赖，就可以正常运行。</div>
      </div>
      <div class="panel-body">
        <b-tree :data="userDefinedData" :props="defaultProps" node-key="id" default-expand-all highlight-current :expand-on-click-node="false"
          :render-content="renderContent"></b-tree>
      </div>
    </section>
    <section class="panel panel-default">
      <div class="panel-heading">
      ...
      <div class="panel-body">
        ...
        <b-tree :data="userDefinedData" :props="defaultProps" :filter-node-method="filterNode" default-expand-all highlight-current
          ref="treeFilter"></b-tree>
      </div>
    </section>
    <section class="panel panel-default">
      <div class="panel-heading">
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      getTreeNodes() {
        console.log(this.$refs.tree.getTreeNodes())
      },
      getCheckedNodes() {
